        ...
        <div className='h-full '>
            ...
            <section style={{ backgroundColor: '#2c6e49' }} className='h-full flex flex-col '>
                ...
                <div className='flex flex-col items-start mx-3 gap-3'>
                    ...
                    <Button href='/dashboard' className='flex gap-3 items-center justify-start h-12 p-2 hover:bg-linear-to-r/srgb from-yellow-600 to-green-700 w-full rounded-2xl ' style={{ backgroundColor: '#2c6e49' }}>
